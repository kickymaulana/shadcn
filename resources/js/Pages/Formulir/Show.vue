...
<template>
    ...
    <div class="flex flex-col gap-6 p-4 md:p-8 pt-4">
        ...
        <Card class="border-none shadow-sm overflow-hidden">
            <CardHeader
                class="flex flex-row items-center justify-between bg-muted/20 pb-4 border-b"
            >
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <CardTitle
                            ...
                            >Formulir #{{ formulir.id }}</CardTitle
                        >
                        <CardDescription class="text-xs"
                            >Informasi Lengkap Pengajuan Sampel</CardDescription
                        >
                    </div>
                </div>
                    ...
                    <DropdownMenuContent align="end" class="w-40">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger as-child>
                                <div
                                    class="relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none transition-colors hover:bg-destructive hover:text-destructive-foreground"
                                >
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    <AlertDialogTitle
                                        >Hapus Formulir?</AlertDialogTitle
                                    >
                                    <AlertDialogDescription
                                        >Data akan hilang permanen dari database
                                        SISAMCUS.</AlertDialogDescription
                                    >
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                ...
                <Table>
                    <TableBody>
                        <TableRow class="hover:bg-transparent border-b">
                            <TableCell
                                class="bg-muted/10 font-bold text-[10px] uppercase text-muted-foreground w-1/6"
                                >Status</TableCell
                            >
                            ...
                            <TableCell
                                class="bg-muted/10 font-bold text-[10px] uppercase text-muted-foreground w-1/6"
                                >Kode Sample</TableCell
                            >
                            <TableCell
                                class="w-2/6 font-mono font-bold text-primary"
                                >{{ formulir.sampel.kode_sample }}</TableCell
                            >
                        </TableRow>
                        <TableRow class="hover:bg-transparent border-b">
                            <TableCell
                                class="bg-muted/10 font-bold text-[10px] uppercase text-muted-foreground"
                                >Running Ke-</TableCell
                            >
                            <TableCell
                                ><Badge class="bg-black text-white">{{
                                    formulir.running_ke
                                }}</Badge></TableCell
                            >
                            <TableCell
                        ...
                        <TableRow class="hover:bg-transparent border-b">
                            ...
                            <TableCell
                                ...
                                >{{ formulir.pemeriksa }}</TableCell
                            >
                            <TableCell
                                class="bg-muted/10 font-bold text-[10px] uppercase text-muted-foreground"
                                >Size / Ukuran</TableCell
                            >
                        ...
                        <TableRow class="hover:bg-transparent">
                            ...
                            <TableCell
                                class="uppercase text-xs font-semibold"
                                >{{ formulir.penyetuju }}</TableCell
                            >
                            <TableCell
                                class="bg-muted/10 font-bold text-[10px] uppercase text-muted-foreground"
                                >Qty Kirim</TableCell
                            >
                            <TableCell class="font-black text-primary"
                                >{{ formulir.qty_sampel_kirim }} Pcs</TableCell
                            >
                        </TableRow>
                    </TableBody>
                </Table>
        ...
        <Card class="border-none shadow-sm overflow-hidden mt-2">
            <CardHeader
                class="flex flex-row items-center justify-between bg-muted/30 py-4 border-b"
            >
                <div class="space-y-1">
                    <CardTitle
                    ...
                    <CardDescription class="text-xs"
                        >Urutan pengerjaan sampel antar unit
                        produksi.</CardDescription
                    >
                </div>
                    ...
                    <TableBody>
                        ...
                        >
                            <TableCell
                                ...
                                >Belum ada data alur proses.</TableCell
                            >
                        </TableRow>
                        <TableRow
                            v-for="(
                        ...
                        >
                            <TableCell
                                class="text-center font-bold text-muted-foreground/50 text-xs"
                                >{{ index + 1 }}</TableCell
                            >
                            <TableCell>
                                <div
                                ...
                                <div
                                    class="text-[9px] text-muted-foreground tracking-tighter uppercase font-medium"
                                >
                                    Master: {{ dept.urutan }}
                                </div>
                            </TableCell>
