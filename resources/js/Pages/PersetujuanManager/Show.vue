                ...
                >
                    ...
                    >
                        ...
                        <div class="border-2 border-slate-900 overflow-hidden">
                            <table
                                class="w-full text-slate-900 border-collapse text-[9px] uppercase"
                            >
                                <thead
                                    class="bg-slate-50 border-b-2 border-slate-900 font-black italic"
                                >
                                    <tr class="h-8">
                                        <th
                                            class="px-3 text-left border-r-2 border-slate-900"
                                        >
                                            Item Pemeriksaan
                                        </th>
                                        <th
                                            class="px-3 text-center w-24 border-r-2 border-slate-900"
                                        >
                                            Spec
                                        </th>
                                        <th class="px-3 text-center w-32">
                                            Actual
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr
                                        ...
                                        :key="idx"
                                        class="border-b border-slate-900 last:border-0 h-7 font-medium"
                                    >
                                        <td class="px-3 font-bold">
                                            {{ row.item }}
                                        </td>
                                        <td
                                            class="px-3 text-center border-x-2 border-slate-900 font-mono font-bold"
                                        >
                                            {{ row.spec }}
                                        </td>
                                        <td
                                            class="px-3 text-center font-black text-primary"
                                        >
                                            {{ row.actual || "-" }}
                                        </td>
                                    </tr>
